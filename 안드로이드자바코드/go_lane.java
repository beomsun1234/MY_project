...
public class go_lane extends AppCompatActivity {
    ImageView car2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.go_lane);

        //button = (Button)findViewById(R.id.connect);
        car2 = (ImageView) findViewById(R.id.imageView5);
        Animation abc = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.translate);
        car2.setAnimation(abc);
        tx2 = (TextView)findViewById(R.id.laneText);
