    ...
    #intialTracbarVals = [10,70,0,100]
        ...
        while not rospy.is_shutdown():
            ...
            try:
                ...
                if abs(old_dst_steer_level - dst_steer_level) > 0.15 and lane_error_detect == 0: ck = 1
...
if __name__ == '__main__':
    print("e")
        #r rospkg.RosPack()
        #crentPath = rp.get_path("ros_controls")
        #rpy.init_node('lane_detector',  anonymous=True)
    intialTracbarVals = [20,50,0,100]
        #iialTracbarVals = [10,70,0,100]
    intialCarRef = 0
    ctrl_lat = p.purePursuit(lfd=0.8)
    image_parser = IMGParser()
    image_parser.initializeTrackbars(intialTracbarVals, intialCarRef)
